...
class DefaultController extends AbstractController
{
    ...
    public function index(Environment $twig, EntityManagerInterface $entity, #[CurrentUser] ?User $app_user)
    {
        ...
        // }
        // $reputation_num = $appuser_like_number - $appuser_dislike_number;
        if($app_user){
