...
class DefaultController extends AbstractController
{
    ...
    public function insertTable($data, Environment $twig): Response
    {
        ...
        try{
            ...
            $this->check_val_address($data, $lastId);
    ...
    public function create_joint_table()
    {
        $connection = $this->create_connection();
        $sql = "
        ...
        try {
            $connection->query($sql) === TRUE;
            $connection->close();
            return new Response("Table 'person_address' created successfully.\n");
        } catch (mysqli_sql_exception $e) {
            echo "Error creating table person_address: " . $connection->error . "<br>";
        }
    }
    ...
    public function add_person_address(mixed $person_id, mixed $address)
    {
        $this->create_joint_table();
        $connection = $this->create_connection();
        $sql = "
        INSERT INTO person_address (person_id, address)
    ...
    public function check_val_address(mixed $data, int $lastId)
    {
        $connection = $this->create_connection();
        $this->create_address();
        $address = "";
        ...
        $person_id = $lastId;
        $this->add_person_address($person_id, $address);
